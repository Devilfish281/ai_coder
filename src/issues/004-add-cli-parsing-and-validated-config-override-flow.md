...
- [x] CLI arguments are parsed into a temporary structure before mutation.
- [x] CLI values are validated before being applied to setup_config.py.
- [x] Invalid CLI values leave setup_config.py unchanged.
- [x] Validation runs again after valid CLI overrides are applied.
- [x] Tests cover valid override and invalid override behavior.
